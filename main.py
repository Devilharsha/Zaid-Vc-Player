...
async def load_start():
    ...
    if restart_data:
        print("[INFO]: SENDING RESTART STATUS TO shu kerenia SERVER")
        try:
    ...
    await client.send_message(LOG_GROUP_ID, "Assistant Of shu Music Started")
    print("[INFO]: STARTED THE shu BOT AND SENDING THE INFO TO ZAID SERVER")
